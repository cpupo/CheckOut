...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    // A default location (Botucatu, Brazil) and default zoom to use when location permission is
    // not granted.
    private final LatLng mDefaultLocation = new LatLng(-22.8940581,-48.4454956);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //STEP 7.4.c replaced by request location permission
